	    ...
	    <div class="nav-tabs-horizontal">
	    	<ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" style="width:33%">
                	<a class="nav-link active" href="<?php echo BASE_URL.'district/manage_surveys?school_id='.$_GET['school_id']; ?>" style="background: #dfdfdf"><strong>Manage Surveys</strong></a>
                </li>
		  		<li class="nav-item" style="width:33%">
