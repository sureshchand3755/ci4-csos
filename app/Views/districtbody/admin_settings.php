                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control" placeholder="Username" value="<?php echo $selectval['username']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="adminemail" id="adminemail" class="form-control" placeholder="Email" value="<?php echo $selectval['email']; ?>">
                        ...
                        <form role="form" id="siteform" action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="sitetitle" id="sitetitle" class="form-control" value="<?php echo $selectval['sitetitle']; ?>">

                                    <span class="input-group-addon"><i class="fa fa-check"></i></span>

                                </div>

                                <label id="sitetitle-error" class="error" for="sitetitle"></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="youtube" id="youtube" class="form-control" placeholder="Youtube" value="<?php echo $selectval['youtube']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="facebook" id="facebook" class="form-control" placeholder="Facebook" value="<?php echo $selectval['facebook']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="twitter" id="twitter" class="form-control" placeholder="Twitter" value="<?php echo $selectval['twitter']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="linkedin" id="linkedin" class="form-control" placeholder="LinkedIn" value="<?php echo $selectval['linkedin']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="googleplus" id="googleplus" class="form-control" placeholder="Google Plus" value="<?php echo $selectval['googleplus']; ?>">

                                </div>

                                <label id="googleplus-error" class="error" for="googleplus"></label>
