		...
		<div class="nav-tabs-horizontal">
            ...
            <ul class="nav nav-tabs" role="tablist" style="margin-top:10px">
                <li class="nav-item" style="width:33%">
		  		...
		  		<li class="nav-item" style="width:33%">
		  			<a class="nav-link" href="<?php echo BASE_URL.'district/manage_reviewed_surveys?school_id='.$_GET['school_id']; ?>" style="background: #dfdfdf"><strong>Completed and Returned Surveys</strong></a>
		  		</li>
            </ul>
        </div>
							...
							<table class="table table-striped">
								...
								<tbody id="tdistrict">
									...
									if(!empty($select_templates)){
										...
										{
											$href=BASE_URL.'/district/delete_templates/'.$template['id'];
											?>
												<tr>
												<td><?php echo $i; ?></td>
												...
												<td>
													<a href='<?php echo BASE_URL."district/add_submitted_template/".$template['id']; ?>' class="fa fa-pencil" title="View Survey" style="font-size:23px"></a>
