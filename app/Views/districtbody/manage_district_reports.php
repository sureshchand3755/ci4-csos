					...
					<div class="col-md-12 dropdown" role="presentation">
						...
						<div class="col-md-2">
							...
							<select class="form-control select_category" name="select_category">
					        	...
					        	<option value="0">Expanded Learning Opportunities Grant Plan</option>
...
$(window).change(function(e){
...

	{
		...
		$.ajax({
			...
			url:"<?php echo BASE_URL.'district/filter_by_district_search'; ?>",
			...
			$.ajax({
...

				{
...

					{
						...
						window.location.replace("<?php echo BASE_URL.'district/manage_lcap_template/'; ?>"+result['template_id']+"?district_id="+district_id);

					}

					else{

						window.location.replace("<?php echo BASE_URL.'district/manage_report_template/'; ?>"+result['template_id']+"?district_id="+district_id);
