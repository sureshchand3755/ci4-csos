		...
		<div class="nav-tabs-horizontal">
            ...
            <ul class="nav nav-tabs" role="tablist" style="margin-top:10px">
                <li class="nav-item" style="width:33%">
		  		...
		  		<li class="nav-item" style="width:33%">
		  			<a class="nav-link " href="<?php echo BASE_URL.'admin/manage_submitted_surveys?school_id='.$school_id; ?>" style="background: #dfdfdf"><strong>Surveys completed by school and returned</strong></a>
		  		</li>
		  		<li class="nav-item" style="width:33%">
