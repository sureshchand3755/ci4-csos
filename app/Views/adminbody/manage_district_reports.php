...
<section class="page-content" style="margin-top: 73px;">
...
<section class="panel">
    ...
    <div class="panel-heading">
        ...
        <h3>MANAGE ALL FISCAL REPORTS</h3>
		...
		<div class="row" id="content">
			...
			<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="col-md-12 dropdown" role="presentation">

						

						<div class="col-md-1">

							<label style="float:right;margin-top:10px">Filter By District:</label>
						...
						<div class="col-md-1">
							...
							<label style="float:right;margin-top:10px">Filter By School:</label>

						</div>

						<div class="col-md-2">

							<select class="form-control select_school" name="select_school">
						...
						<div class="col-md-1">
							...
							<label style="float:right;margin-top:10px">Filter By Report:</label>
...

							                    {
													...
													?>
														...
														<td>
															...
															<h6>Report Submitted By School <br/><br/><span class="change_date_span"><?php echo date('m/d/Y',strtotime($attachment['updatetime'])); ?></span><a href="javascript:" class="fa fa-pencil edit_date" data-element="<?php echo $attachment['id']; ?>" data-date="<?php echo date('m/d/Y',strtotime($attachment['updatetime'])); ?>" style="margin-left:10px"></a></h6>
														...
														<td>
															...
															<a href='<?php echo BASE_URL."admin/delete_report_attachment/".$attachment['id']."?district_id=".$attachment['district_id']; ?>' class="fa fa-trash delete_report_attach" title="Delete Report" style="font-size:23px"></a>
...
$(window).change(function(e){
...

	{
		...
		$.ajax({
			...
			url:"<?php echo BASE_URL.'admin/filter_by_district_search'; ?>",

			type:"post",

			data:{category:category,school_id:school_id,district_id:district_id,year:year},
			...
			$.ajax({
...

				{
...

					{
						...
						window.location.replace("<?php echo BASE_URL.'admin/manage_lcap_template/'; ?>"+result['template_id']+"?district_id="+district_id);

					}

					else{

						window.location.replace("<?php echo BASE_URL.'admin/manage_report_template/'; ?>"+result['template_id']+"?district_id="+district_id);
