        ...
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top:20px">
                ...
                <div class="select_school_div">
                    <h6 style='margin-left: 27px;color: #717171;'>Please select the District</h6>
                </div>
            </div>
            <div class="col-md-12">
  ...
  <div class="modal-dialog modal-sm" role="document" style="width:40%">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
            <label style="font-weight:600">Select District:</label>
            <select name="select_district_due" class="form-control select_district_due">
                <option value="">Select District</option>
                <?php
                if(!empty($districts))
                {
...
<script>
    ...
    $(window).change(function(e) {
        ...
        if($(e.target).hasClass('select_district'))
        {
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    $(".select_school_div").html(result);
                }
            })
        }
        if($(e.target).hasClass('select_district_due'))
        {
            var value = $(e.target).val();
            $.ajax({
                url:"<?php echo BASE_URL.'admin/school_lists_checkbox'; ?>",
                ...
                success:function(result)
                {
                    $("#select_all_schools").show();
                    $(".select_all_schools_cls").show();
                    $(".select_school_div_due").html(result);
                }
            })
        }
    ...
    $(window).click(function(e) {
        ...
        if($(e.target).hasClass('download_reports'))
        {
            ...
            $(".select_school_div").html("<h6 style='margin-left: 27px;color: #717171;'>Please select the District</h6>");
            $(".category_select").prop("checked",false);
            $(".select_district").val("");
        }
        if($(e.target).hasClass('submit_download_report'))
        {
            ...
            else if(year == "")
            {
                ...
                setTimeout(function() {
                    ...
                    $.ajax({
                        url:"<?php echo BASE_URL.'admin/download_view_reports'; ?>",
                        type:"post",
        ...
        if($(e.target).hasClass('submit_due_date'))
        {
            ...
            var district_id = $(".select_district_due").val();
            var school_ids = '';
            ...
            else if(due_date_11 == "" && due_date_12 == "" && due_date_13 == "" && due_date_14 == "" && due_date_15 == "" && due_date_16 == "" && due_date_1 == "" && due_date_2 == "" && due_date_3 == "" && due_date_4 == "" && due_date_5 == "" && due_date_6 == "" && due_date_7 == "" && due_date_8 == "" && due_date_9 == "")
            {
                ...
                $.ajax({
                    url:"<?php echo BASE_URL.'admin/set_due_dates'; ?>",
                    type:"post",
                    data:{district_id:district_id,school_ids:school_ids,year:year,due_date_11:due_date_11,due_date_12:due_date_12,due_date_13:due_date_13,due_date_14:due_date_14,due_date_15:due_date_15,due_date_16:due_date_16,due_date_1:due_date_1,due_date_2:due_date_2,due_date_3:due_date_3,due_date_4:due_date_4,due_date_5:due_date_5,due_date_6:due_date_6,due_date_7:due_date_7,due_date_8:due_date_8,due_date_9:due_date_9},
                    success:function(result)
                    {
        ...
        if($(e.target).hasClass('submit_filter'))
        {
            ...
            else if(year == "")
            {
                ...
                $.ajax({
                    url:"<?php echo BASE_URL.'admin/reports_result'; ?>",
                    type:"post",
