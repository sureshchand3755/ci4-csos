		...
		<div class="nav-tabs-horizontal">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item" style="width:33%">
                	...
                	<a class="nav-link" href="<?php echo BASE_URL.'admin/manage_surveys?school_id='.$_GET['school_id']; ?>" style="background: #dfdfdf"><strong>Manage Surveys</strong></a>
...

							                    {
													...
													?>
														...
														<td>
															...
															<a href="<?php echo BASE_URL."admin/delete_report_attachment/".$attachment['id']."?school_id=".$attachment['school_id']; ?>" class="fa fa-trash delete_report_attach" title="Delete Report" style="font-size:23px"></a>
...
$(window).change(function(e){
...

	{
		...
		$.ajax({
			...
			url:"<?php echo BASE_URL.'admin/filter_by_school_search'; ?>",
