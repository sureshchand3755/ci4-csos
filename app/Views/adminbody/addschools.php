                                            ...
                                            <fieldset>
                                                    <div class="control-group" style="margin-top:30px">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" name="school_name" data-required="1" class="form-control" value="<?= isset($selectval['school_name'])?$selectval['school_name']:'' ?>"/>
                                                        </div>
                                                    ...
                                                    <div class="control-group" style="margin-top:30px">
                                                        ...
                                                        <b class="control-label">Select District<span class="required">*</span></b>

                                                        <div class="controls">
                                                            <select name="district_id" class="form-control <?php if(isset($_GET['district_id'])) { echo 'disabled'; } ?>">
                                                            ...
                                                            if(count($districts))
                                                            {
                                                                foreach($districts as $district)
                                                                {
                                                                    ...
                                                                    {
                                                                        if($district['id'] == $_GET['district_id'])
                                                                        {
                                                                            $checked = 'selected';
                                                                        }
                                                                        else{
                                                                        ...
                                                                        if($district['id'] == $selectval['district_id'])
                                                                        {
                                                                            $checked = 'selected';
                                                                        }
                                                                        else{
                                                                    ...
                                                                    echo '<option value="'.$district['id'].'" '.$checked.'>'.$district['district_name'].'</option>';
                                                                }
                                                            }
                                                            ?>
                                                            </select>
        											...
        											<div class="control-group" style="margin-top:30px">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" name="principal_name" data-required="1" class="form-control" value="<?= isset ($selectval['principal_name'])?$selectval['principal_name']:''; ?>"/>
        											...
        											<div class="control-group" style="margin-top:30px">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" name="username" id="username" data-required="1" <?php if(!empty($selectval['username'])) { echo "readonly='readonly'"; } ?> class="form-control" value="<?= isset($selectval['username'])?$selectval['username']:''; ?>"/>
                                        ...
                                        <div class="row">
                                            <fieldset>
                                                <div class="control-group" style="margin-top:30px">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="handbook_name" data-required="1" class="form-control handbook_name" value="<?= isset($selectval['handbook_name'])?$selectval['handbook_name']:''; ?>"/>
                                                ...
                                                <div class="control-group" style="margin-top:30px">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="filename" data-required="1" class="form-control filename" value="<?= isset($selectval['filename'])?$selectval['filename']:''; ?>"/>
                                                ...
                                                <div class="control-group" style="margin-top:30px">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="fiscal_filename" data-required="1" class="form-control fiscal_filename" value="<?= isset($selectval['fiscal_filename'])?$selectval['fiscal_filename']:''; ?>"/>
                                                ...
                                                <div class="control-group" style="margin-top:30px">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="landing_message" class="form-control landing_message editor" id="editor_1"><?= isset($selectval['landing_message'])?$selectval['landing_message']:''; ?></textarea>
