        ...
        <div class="modal-body">
          ...
          <div class="img_div">
             <div class="image_div_attachments">
               <form action="<?php echo BASE_URL.'admin/upload_images'; ?>" method="post" enctype="multipart/form-data" class="dropzone" id="imageUpload" style="clear:both;min-height:80px;background: #949400;color:#000;border:0px solid; height:auto; width:100%; float:left">
	    ...
	    <div class="row">
        	<section class="content">
        	    <!-- Small boxes (Stat box) -->
                     <!-- BEGIN FORM-->
                    <form action="<?php echo BASE_URL.'admin/save_template_content_step3_submitted'; ?>" id="form_sample_3" method="post" enctype="multipart/form-data">
                        <div class="margin-bottom-50">
                            <div class="nav-tabs-horizontal">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo BASE_URL.'admin/add_submitted_template/'.$template_id; ?>">Step 1</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo BASE_URL.'admin/add_submitted_template_step2/'.$template_id; ?>">Step 2</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        {
                          ?>
                          <a href="<?php echo BASE_URL.'admin/manage_reviewed_surveys?school_id='.$template_details['school_id']; ?>" class="btn btn-primary submit_step_3" name="submit_step3" style="margin-top:20px">Go Back to Reviewed Survey</a>
                          <?php
                        }
                        else{
                          ?>
...
$(window).click(function(e) {
  ...
  if($(e.target).hasClass('remove_dropzone_attach'))
  {
    ...
    $.ajax({
      url:"<?php echo BASE_URL.'admin/remove_dropzone_attachment'; ?>",
      type:"post",
  ...
  if($(e.target).hasClass('trash_image'))
  {
    ...
    if (r == true) {
      ...
      $.ajax({
          url:"<?php echo BASE_URL.'admin/infile_delete_image'; ?>",
          type:"get",
          data:{imgid:imgid},
          success: function(result) {
            window.location.reload();
  ...
  if($(e.target).hasClass('delete_all_image')){
    ...
    if (r == true) {
      ...
      $.ajax({
          url:"<?php echo BASE_URL.'admin/infile_delete_all_image'; ?>",
          type:"get",
          data:{id:id},
          success: function(result) {
            window.location.reload();
  ...
  if($(e.target).hasClass('download_selected_sections'))
  {
    ...
    setTimeout( function() {
      ...
      $.ajax({
        url:"<?php echo BASE_URL.'admin/download_pdf_sections'; ?>",
        type:"post",
  ...
  if($(e.target).hasClass('print_selected_sections'))
  {
    ...
    setTimeout( function() {
      ...
      var base_url = "<?php echo BASE_URL; ?>";
      $.ajax({
        url:"<?php echo BASE_URL.'admin/print_pdf_sections'; ?>",
        type:"post",
        data:{template_id:template_id,sections:sections},
        success:function(result)
        {
    ...
    if($(e.target).hasClass('print_pdf'))
    {
    	...
    	setTimeout( function() {
	        ...
	        var base_url = "<?php echo BASE_URL; ?>";
	        $.ajax({
	        	url:"<?php echo BASE_URL.'admin/print_pdf'; ?>",
	        	type:"post",
	        	data:{template_id:template_id},
	        	success:function(result)
	        	{
