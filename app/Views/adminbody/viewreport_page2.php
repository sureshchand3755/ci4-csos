                        ...
                        <div class="margin-bottom-50">
                            <div class="nav-tabs-horizontal">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                       <a class="nav-link" href="<?php echo BASE_URL.'admin/view_report_template/'.$template_id; ?>">Step 1</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content padding-vertical-20">
                                    <div class="tab-pane active" id="home1" role="tabpanel" aria-expanded="false">
                                        ...
                                        <table class="table" style="width:70%">
                                            <thead>
                                                <th style="border:1px solid #dfdfdf;width:40%"><?php echo $selectval['step2_table_title_1']; ?></th>
                                                <th style="border:1px solid #dfdfdf"><?php echo $selectval['step2_table_title_2']; ?>"></th>
                                            </thead>
                                                    ...
                                                    foreach($report_forms as $report)
                                                    {
                                                        ...
                                                        <tr class="content_tr" data-element="<?php echo $report['id']; ?>">
                                                            ...
                                                            <td style="border:1px solid #dfdfdf;vertical-align: bottom;">
                                                                <label class="switch">
                                                                    <input type="checkbox" class="attach_class" value="1" data-element="<?php echo $report['id']; ?>" <?php echo $check_attach; ?> disabled>
