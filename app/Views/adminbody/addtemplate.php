                                ...
                                <div class="tab-content padding-vertical-20">
                                    <div class="tab-pane active" id="home1" role="tabpanel" aria-expanded="false">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control template_name" name="template_name" placeholder="Enter Template Name" value="<?= isset($selectval['template_name'])?$selectval['template_name']:''; ?>">
                                            </div>
                                        </div>
                                        <hr>
                                                ...
                                                if(count($unserialize)){
                                                    ...
                                                    foreach($unserialize as $key => $content)
                                                    {
                                                        ...
                                                        <div class="form-group take_copy_div row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control content_title content_title_<?php echo $i; ?>" name="content_title[]" placeholder="Enter Title" required value="<?php echo $key; ?>">
                                                            </div>
                                                            <div class="col-md-4 action_div">
                                                                <a href="javascript:" class="fa fa-trash remove_content" style="font-size:20px;color:#f00;padding: 8px;border: 1px solid #dfdfdf;background: #dfdfdf;" title="Remove this Content"></a>
                                                                <?php 
                                                                if($i == $total_count)
                                                                {
                                                                    ?>
                                                                    <a href="javascript:" class="fa fa-plus add_content" style="font-size:20px;color:green;padding: 8px;border: 1px solid #dfdfdf;background: #dfdfdf;" title="Add New Content"></a>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </div>
                                                            <div class="col-md-8" style="margin-top:20px">
                                                                <textarea class="form-control editor" name="editor_<?php echo $i; ?>" id="editor_<?php echo $i; ?>" <?php echo $disabled; ?>><?php echo $content; ?></textarea>
                                                            </div>
                                                            <div class="col-md-4">
                                                                &nbsp;
                                                            </div>
