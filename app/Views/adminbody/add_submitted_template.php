	    ...
	    <div class="row">
        	<section class="content">
        	    <!-- Small boxes (Stat box) -->
                     <!-- BEGIN FORM-->
                    <form action="<?php echo BASE_URL.'admin/save_template_content_submitted'; ?>" id="form_sample_3" method="post" enctype="multipart/form-data">
                            ...
                            <div class="nav-tabs-horizontal">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <?php
                                        if(!empty($selectval)) { ?>
                                            <a class="nav-link" href="<?php echo BASE_URL.'admin/add_submitted_template_step3/'.$template_id; ?>">Step 3</a>
                                        <?php } else { ?>
