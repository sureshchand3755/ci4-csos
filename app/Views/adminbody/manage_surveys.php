	    ...
	    <div class="nav-tabs-horizontal">
	    	<ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" style="width:33%">
                	<a class="nav-link active" href="<?php echo BASE_URL.'admin/manage_surveys?school_id='.$school_id; ?>" style="background: #dfdfdf"><strong>Manage Surveys</strong></a>
                </li>
		  		<li class="nav-item" style="width:33%">
            ...
            <ul class="nav nav-tabs" role="tablist" style="margin-top:10px">
                <li class="nav-item" style="width:33%">
		  		...
		  		<li class="nav-item" style="width:33%">
		  			<a class="nav-link" href="<?php echo BASE_URL.'admin/manage_submitted_surveys?school_id='.$_GET['school_id']; ?>" style="background: #dfdfdf"><strong>Surveys completed by school and returned</strong></a>
		  		</li>
		  		<li class="nav-item" style="width:33%">
		  			<a class="nav-link" href="<?php echo BASE_URL.'admin/manage_reviewed_surveys?school_id='.$_GET['school_id']; ?>" style="background: #dfdfdf"><strong>Completed and Returned Surveys</strong></a>
		  		</li>
            </ul>
        </div>
										...
										foreach($select_templates as $template)
										{
											...
											?>
												...
												<td>
													...
													<a href='<?php echo BASE_URL."admin/delete_survey/".$template['id']."?district_id=".$_GET['district_id']."&school_id=".$_GET['school_id'].""; ?>' class="fa fa-trash delete_survey" title="Delete Survey" style="font-size:23px"></a>
													</td>
												</tr>
											<?php 
											$i++;
