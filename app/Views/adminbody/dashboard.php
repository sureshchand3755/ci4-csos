    ...
    <div class="row">
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven background-success">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'admin/manage_district'; ?>">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven background-default">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'admin/manage_schools'; ?>">
                            <div href="javascript: void(0);" class="widget-body-inner">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven" style="background: #009750">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'admin/documents_timeline'; ?>">
                            <div href="javascript: void(0);" class="widget-body-inner">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven" style="background: #ffeb3b">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'admin/manage_templates'; ?>">
                            <div href="javascript: void(0);" class="widget-body-inner">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'admin/manage_full_surveys'; ?>">
                            <div href="javascript: void(0);" class="widget-body-inner">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven" style="background: #7ebcff">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'admin/view_result_reports'; ?>">
                            <div href="javascript: void(0);" class="widget-body-inner">
