	...
	<section class="content">
		...
		<div class="nav-tabs-horizontal">
            ...
            <ul class="nav nav-tabs" role="tablist" style="margin-top:10px">
                <li class="nav-item" style="width:33%">
                	<a class="nav-link active"href="javascript:" style="background: #dfdfdf"><strong>Surveys Not Submitted</strong></a>
                </li>
		  		<li class="nav-item" style="width:33%">
		  		...
		  		<li class="nav-item" style="width:33%">
		  			<a class="nav-link" href="<?php echo BASE_URL.'school/manage_reviewed_surveys'; ?>" style="background: #dfdfdf"><strong>Reviewed Surveys</strong></a>
		  		</li>
            </ul>
        </div>
