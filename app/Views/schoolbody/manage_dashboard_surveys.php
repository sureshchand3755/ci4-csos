  ...
  <div class="page-content-inner">
    ...
    <div class="dashboard-container">
        <div class="row">
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven" style="background: #ffeb3b">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'school/manage_surveys'; ?>">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven" style="background: #CDDC39">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'school/manage_submitted_surveys'; ?>">
                            <div href="javascript: void(0);" class="widget-body-inner">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven" style="background: #afe6ff">
                    <div class="widget-body">
                        <a href="<?php echo BASE_URL.'school/manage_reviewed_surveys'; ?>">
                            <div href="javascript: void(0);" class="widget-body-inner">
